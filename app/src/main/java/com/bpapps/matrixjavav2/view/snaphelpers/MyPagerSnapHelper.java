package com.bpapps.matrixjavav2.view.snaphelpers;
...
public class MyPagerSnapHelper extends androidx.recyclerview.widget.PagerSnapHelper {
    ...
    private RecyclerView.OnScrollListener scrollListener = new RecyclerView.OnScrollListener() {
        ...
        public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
            ...
            MyPagerSnapHelper.this.onScrollStateChanged(newState);
        }
    };

    public MyPagerSnapHelper(int gravity) {
        this(gravity, false, null);
    }

    public MyPagerSnapHelper(int gravity, @NonNull GravitySnapHelper.SnapListener snapListener) {
        this(gravity, false, snapListener);
    }

    public MyPagerSnapHelper(int gravity, boolean enableSnapLastItem) {
    ...
    /**
     * Sets a {@link GravitySnapHelper.SnapListener} to listen for snap events
     *
     * @param listener a {@link GravitySnapHelper.SnapListener} that'll receive snap events or null to clear it
     */
     ...
     * <p>
     * This makes sure that a position is reported in {@link GravitySnapHelper.SnapListener#onSnap(int)}
     */
